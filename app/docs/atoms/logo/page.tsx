...
export default function LogoPage() {
  return (
    <ComponentPage
      name="Logo"
      description="A radius-aware logo primitive with optional hover or looping shine."
      importCode={`import { Logo } from "@/components/ui/atoms/logo";`}
    >
      <DemoSection
        title="Shine effects"
        code={`<Logo effect="none" />\n<Logo effect="shine" />\n<Logo effect="shine-loop" />`}
      >
