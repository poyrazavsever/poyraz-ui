          ...
          <CardContent className="space-y-3">
            <div className="grid grid-cols-2 gap-2">
              <div className="space-y-1.5">
                ...
                <Input id="signup-first" placeholder="Poyraz" />
              </div>
              <div className="space-y-1.5">
                <Label htmlFor="signup-last">Last name</Label>
                <Input id="signup-last" placeholder="Avsever" />
              </div>
            </div>
            <div className="space-y-1.5">
...
export default function AuthTemplatePage() {
  return (
    <ComponentPage
      ...
      description="Authentication page templates with email/password forms, social login options, and terms acceptance. Uses Card, Input, Label, Checkbox, Button, and Separator atoms."
      importCode={`import {
  Button, Input, Label, Checkbox, Separator, Typography,
  Card, CardHeader, CardTitle, CardDescription, CardContent, CardFooter,
} from "poyraz-ui/atoms";`}
    >
      <DemoSection
        title="Login"
        description="Sign-in form with remember me, forgot password, and social auth buttons."
        code={loginCode}
      >
        <LoginPreview />
      </DemoSection>
      ...
      <DemoSection
        title="Signup"
        description="Registration form with name fields, password requirements, terms checkbox, and social auth."
        code={signupCode}
      >
        <SignupPreview />
      </DemoSection>
