...
export default function DashboardTemplatePage() {
  return (
    <ComponentPage
      name="Soft Glass Dashboard"
      description="A source-owned dashboard shell with semantic glass surfaces, responsive navigation and data-driven content."
      importCode={`import { DashboardShellBlock, SmartDashboardBlock } from "@/components/ui/blocks";`}
    >
      <DemoSection
        title="Dashboard Shell"
        description="Sidebar visibility, metric columns and content padding follow the preview container instead of the browser viewport."
        code={code}
      >
        <BlockPreview>
          <DashboardShellBlock>
