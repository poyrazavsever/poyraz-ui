...
export default function CalendarPage() {
  return (
    <ComponentPage
      name="Calendar"
      description="An inline date calendar component with month navigation. Supports single-date selection with custom styling."
      importCode={`import { Calendar } from "poyraz-ui/molecules";`}
    >
      <DemoSection
        title="Default"
        description="Interactive calendar with the current date selected."
...
<Calendar selected={date} onSelect={setDate} />`}
      ...
      <DemoSection
        ...
        description="Calendar with no date pre-selected."
