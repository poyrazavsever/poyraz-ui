...
import { X, Search, ChevronDown, Menu, PanelLeftClose, PanelLeftOpen, SlidersHorizontal, Check, ArrowUp, ArrowDown, ArrowUpDown, ChevronsLeft, ChevronLeft, ChevronRight, ChevronsRight } from 'lucide-react';
...
var NavbarMobileGroup = React.forwardRef((_a, ref) => {
  var _b = _a, { className, label, children } = _b, props = __objRest(_b, ["className", "label", "children"]);
...
var NavbarMobileActions = React.forwardRef((_a, ref) => {
  var _b = _a, { className, children } = _b, props = __objRest(_b, ["className", "children"]);
  return /* @__PURE__ */ jsx(
    "div",
    __spreadProps(__spreadValues({
...
var NavbarSearch = React.forwardRef(
  (_a, ref) => {
    var _b = _a, {
      className,
      placeholder = "Search\u2026",
...
var NavbarDivider = React.forwardRef((_a, ref) => {
  var _b = _a, { className } = _b, props = __objRest(_b, ["className"]);
  return /* @__PURE__ */ jsx(
    "div",
    __spreadValues({
...
var SidebarSearch = React.forwardRef(
  (_a, ref) => {
...
var SidebarSubMenu = React.forwardRef(
  (_a, ref) => {
...
var SidebarSubMenuItem = React.forwardRef((_a, ref) => {
...
var SidebarUserProfile = React.forwardRef((_a, ref) => {
...
var FooterNewsletter = React.forwardRef(FooterNewsletterInner);
FooterNewsletter.displayName = "FooterNewsletter";
var FooterDivider = React.forwardRef((_a, ref) => {
  var _b = _a, { className } = _b, props = __objRest(_b, ["className"]);
  return /* @__PURE__ */ jsx(
    "hr",
    __spreadValues({
