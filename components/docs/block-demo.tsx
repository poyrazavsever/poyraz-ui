...
import {
  ...
  CenteredFooterBlock,
  CompactFooterBlock,
} from "@/components/ui/blocks/phase8/footer-blocks";
...
export function BlockDemo({ name }: { name: string }) {
  switch (name) {
      ...
      return (
        <div className="mx-auto max-w-md">
          <ArticleCard
            ...
            title="Designing a registry-first component system"
            excerpt="How source ownership changes the way teams compose and maintain interface primitives."
    ...
    case "auth-card-block":
      return <AuthCardBlock />;
    case "brand-hero-block":
      return <BrandHeroBlock />;
    case "dashboard-shell-block":
      return (
        <DashboardShellBlock>
          <SmartDashboardBlock />
        </DashboardShellBlock>
      ...
      return (
        <div className="mx-auto max-w-md">
          <ImageCard
            image={image}
            badge="Featured"
            title="Source-owned interfaces"
            description="A visual card block with semantic overlay content."
          />
        </div>
      );
    case "mega-menu-block":
      return <MegaMenuBlock />;
    case "mobile-navigation-block":
      return (
        <div className="mx-auto max-w-md">
          <MobileNavigationBlock activeHref="#components" />
        </div>
      );
    case "mobile-sidebar-block":
      return (
    ...
    case "navigation-block":
      return <NavigationBlock activeHref="#components" />;
    case "news-card":
      return (
        <div className="mx-auto max-w-lg">
          <NewsCard
            image={image}
            category="Release"
            title="Poyraz UI v3 registry documentation is taking shape"
            date="July 13, 2026"
          />
        </div>
      );
      ...
      return (
        <div className="mx-auto max-w-sm">
          <PricingCard
            ...
            features={["Unlimited projects", "All registry blocks", "Priority support"]}
            highlighted
    ...
    case "product-card":
      return (
        <div className="mx-auto max-w-sm">
          <ProductCard
            image={image}
            title="Poyraz UI component pack"
            price="$29"
            originalPrice="$49"
            rating={4.8}
            badge="New"
    ...
    case "smart-dashboard-block":
      return <SmartDashboardBlock />;
    case "stats-card":
      return (
        <div className="mx-auto max-w-sm">
          <StatsCard
    ...
    case "testimonial-card":
      return (
        <div className="mx-auto max-w-md">
          <TestimonialCard
            quote="The registry model gave our team a clear component baseline without taking ownership away from us."
            author="Selin Kaya"
